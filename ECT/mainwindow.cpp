...
void MainWindow::realtime_measure_with_usb()
{
...
void MainWindow::read_data_in_file()//从文件读取
{
    ...
    QString a=time_datetime.toString("yyyy.MM.dd-hh:mm:ss.zzz");
    if(str_datetime==a)
    {
